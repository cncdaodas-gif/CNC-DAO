...
export const metadata: Metadata = {
  title: { default:'CNC DAO', template:'%s · CNC DAO' },
  description: 'Solana-based regenerative finance rewarding real-world environmental action.',
  icons: {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="https://raw.githubusercontent.com/cncdaodas-gif/CNC-DAO/882f885f89c906eed6ee1a28374bd83e2242ac97/assets/logo.jpg" type="image/jpeg" />
      </head>
      <body>
